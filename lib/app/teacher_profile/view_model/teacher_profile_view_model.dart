...
import 'package:eltafouk_ecademy/app/teacher_profile/model/delete_image_model.dart';
import 'package:eltafouk_ecademy/app/teacher_profile/model/teacher_data_model.dart';
import 'package:eltafouk_ecademy/app/teacher_profile/model/upload_image_model.dart';
import 'package:eltafouk_ecademy/base_view_model.dart';
import 'package:eltafouk_ecademy/comman_model/upload_image_model.dart';
...
class TeacherProfileViewModel extends BaseViewModel {
  ...
  getTeacherData(context, token) async {
    var data = await apiServices.getTeacherData(token: token,teacherId: "16");
    if (data == 'fail') {
      AwesomeDialog(
        context: context,
        dialogType: DialogType.ERROR,
