...
import 'package:eltafouk_ecademy/main.dart';
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return list.isEmpty
                  ...
                  : Container(
                decoration: BoxDecoration(color: whiteColor,border: Border.all(color: foshiaColor),borderRadius: BorderRadius.circular(15) ),
